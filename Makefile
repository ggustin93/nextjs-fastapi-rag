...
ingest: ## Ingest documents into vector DB
	...
	@echo "════════════════════════════════════════════════════════════"
	@echo ""
	@echo "📄 [1/3] Ingesting documents from data/raw/documents/..."
	@uv run python -m packages.ingestion.ingest --documents data/raw/documents/ || echo "⚠️  No documents found or ingestion failed"
	@echo ""
	@echo "📝 [2/3] Ingesting custom notes from data/raw/notes/..."
	@uv run python -m packages.ingestion.ingest --documents data/raw/notes/ --no-clean || echo "⚠️  No notes found or ingestion failed"
	@echo ""
	@echo "🌐 [3/3] Ingesting scraped web content from data/processed/scraped/..."
